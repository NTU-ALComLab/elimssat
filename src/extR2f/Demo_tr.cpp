...
//    Abc_Ntk_t* pNtkRel = createRelNtk(pNtk); 
    ...
    insertDC(pNtkRel, rate);
   // Abc_Ntk_t* pNtkInsertDC = 
   /* Abc_Ntk_t* pNtkTemp = createNtkUni(pNtkRel, pNtkCube);
   ...
   // Abc_NtkShow(pNtkDRel, 0, 0, 0);
    //Abc_NtkShow(Abc_NtkStrash(pNtkCube, 0, 0, 0))), 0, 0, 0);
